...
document.addEventListener("click", (e)=>{
    ...
    if (coords.top + spider.offsetHeight > wall.offsetHeight) coords.top = wall.offsetHeight - spider.offsetHeight - wall.clientTop * 2;
    if (coords.left + spider.offsetWidth > wall.offsetWidth) coords.left = wall.offsetWidth - spider.offsetWidth - wall.clientLeft * 2;
